    ...
    menuItems: [
      ...
      },
      {
        icon: (
          ...
          >
            <path
              d="M15.7221 12.4969L14.5596 10.9219V7.79065C14.5596 4.64065 12.1502 2.1094 9.0002 2.1094C5.85019 2.1094 3.44082 4.64065 3.44082 7.79065V10.9219L2.27832 12.4969C2.16957 12.6338 2.11332 12.8269 2.11332 13.0201V14.5406C2.11332 14.9063 2.39457 15.1875 2.7602 15.1875H15.2402C15.6058 15.1875 15.8871 14.9063 15.8871 14.5406V13.0201C15.8871 12.8269 15.8308 12.6338 15.7221 12.4969Z"
              fill="none"
              stroke="currentColor"
              stroke-width="1.2"
            ...
            />
            <path
              d="M9.0002 17.5219C10.3783 17.5219 11.5033 16.4532 11.5033 15.1313H6.49707C6.49707 16.4532 7.62207 17.5219 9.0002 17.5219Z"
              fill="none"
              stroke="currentColor"
              stroke-width="1.2"
              stroke-linecap="round"
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={`text- [#222222] fixed left-0 top-0 z-9999 flex h-screen w-72.5 flex-col  bg-white duration-300 ease-linear dark:bg-boxdark lg:translate-x-0 ${
          sidebarOpen ? "translate-x-0" : "-translate-x-full"
        }`}
      >
        {/* <!-- SIDEBAR HEADER --> */}
        <div className="flex items-center justify-between gap-1 px-6 lg:py-6.5">
          <Link href="/" className="pl-10 text-4xl font-bold">
            Vaikunth
          </Link>
