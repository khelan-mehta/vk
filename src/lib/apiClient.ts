...
class Client {
  ...
  private headers: object | RawAxiosResponseHeaders = {};
  ...
  constructor(
    ...
    this.instance =
      this.instance === null
        ? cache
          ? setupCache(axios.create(this.config))
          : axios.create(this.config)
        : this.instance; //singleton instance to be used
    if (throttle) {
  ...
  public setHeaders(hd: object | RawAxiosResponseHeaders): requests {
    this.headers = hd;
    return this;
  }
  ...
  public async get(endpoint: string, params?: object): Promise<any> {
    try {
      ...
      // console.log(dt)
      if (dt !== null) {
        const result: AxiosResponse | undefined = await this.instance?.get(
  ...
  public async post(endpoint: string, data?: any): Promise<any> {
    try {
      const result: AxiosResponse | undefined = await this.instance?.post(
        this.baseUrl + endpoint,
        data,
        {
          headers: this.headers,
  ...
  public async put(
    ...
    try {
      const result: AxiosResponse | undefined = await this.instance?.put(
        this.baseUrl + endpoint,
        data,
        {
          params: params,
  ...
  public async delete(endpoint: string, data?: any): Promise<any> {
    try {
      const result: AxiosResponse | undefined = await this.instance?.delete(
        this.baseUrl + endpoint,
        {
          params: data,
          headers: this.headers,
